...
class StableDiffusion:
    model_ref = bentoml.models.get("sd2-model:latest")
    ...
    @bentoml_io.api
    def text2img(self, input_data: dict = sample_text2img_input) -> Image:
    ...
    @bentoml_io.api
    def img2img(self, image: Image, input_data: dict = sample_img2img_input) -> Image:
